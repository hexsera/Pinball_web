...
│       ├── game_sessions.py   # /api/v1/game-sessions (게임 세션, Redis 사용) — 구현 예정
...
└── schemas/
    ...
    ├── game_session.py  # GameSessionSaveRequest/Response — 구현 예정
...
| GET/PUT/DELETE | /api/v1/game-sessions/{user_id} | 없음 | 게임 세션 관리 (Redis, 구현 예정) |
